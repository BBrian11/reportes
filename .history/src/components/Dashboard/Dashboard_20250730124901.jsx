        ...
        const nuevos = snapshot.docs.map((doc) => {
          ...
          return {
            ...
            fecha: d.fechaHoraEnvio
              ...
              : "Sin Fecha",
            fechaObj: d.fechaHoraEnvio
              ? new Date(d.fechaHoraEnvio.seconds * 1000)
              : null,
    ...
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          {filtros.cliente && (
  <>
    {/* MiniCharts dinámicos */}
    <MiniCharts eventos={eventosFiltrados} />

    {filtros.cliente === "TGS" && (
      <TgsStats eventos={eventosFiltrados} />
    )}
    {filtros.cliente === "Edificios" && (
      <EdificioStats eventos={eventosFiltrados} />
    )}
    {filtros.cliente === "VTV" && (
      <VtvStats eventos={eventosFiltrados} />
    )}
