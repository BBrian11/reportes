    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 text-sm rounded-xl border border-gray-300 bg-gray-50 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all"
        />
      </div>
      ...
      <div className="flex justify-end">
        <button
          ...
          className="flex items-center justify-center gap-2 bg-indigo-600 text-white px-6 py-3 rounded-xl shadow-md hover:bg-indigo-700 hover:shadow-lg transition-all text-sm font-semibold"
        >
