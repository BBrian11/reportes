...
export default function EventsTable({ eventos }) {
  ...
  return (
    <div className="bg-white shadow-xl rounded-xl p-6">
      ...
      <div className="bg-gray-50 p-4 rounded-lg shadow-sm flex flex-wrap gap-3 items-center mb-6 border border-gray-200">
        {/* 🔍 Buscador con ícono */}
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-2 text-sm border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none"
          />
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-3 py-2 text-sm border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none"
          />
        </div>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-lg shadow hover:bg-indigo-700 transition text-sm"
        >
          <FiRotateCcw /> Reset
        </button>
      </div>
