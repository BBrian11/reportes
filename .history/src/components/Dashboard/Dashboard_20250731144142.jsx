...
export default function Dashboard() {
  ...
  // ✅ NUEVO: Estado para imágenes de gráficos
  const [chartImages, setChartImages] = useState({ lineChart: null, pieChart: null });
      ...
      <main className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          {!filtros.cliente ? (
            ...
            <>
              <div className="grid-layout">
                {/* ✅ MiniCharts genera imágenes para el PDF */}
                <MiniCharts eventos={eventosFiltrados} onExportCharts={setChartImages} />

                {/* ✅ Botón PDF con gráficos */}
                <ExportPDF eventos={eventosFiltrados} charts={chartImages} />
