...
export default function GlobalStats({ eventos, cliente }) {
  ...
  eventos.forEach((e) => {
    ...
    // Contar razones PMA solo si el cliente es Edificios
    if (cliente === "Edificios" && e["razones-pma"]) {
  ...
  const eventoMasFrecuente =
    Object.entries(eventCount).sort((a, b) => b[1] - a[1])[0] || ["Sin datos", 0];
  const ubicacionMasFrecuente =
    Object.entries(locationCount).sort((a, b) => b[1] - a[1])[0] || ["Sin datos", 0];
  const razonMasFrecuente =
    cliente === "Edificios"
      ? Object.entries(reasonCount).sort((a, b) => b[1] - a[1])[0] || ["Sin datos", 0]
      : ["No aplica", 0];
  ...
  return (
    <div className="global-card">
      ...
      <div className="global-grid">
        ...
        {/* Razón PMA más frecuente (solo si Edificios) */}
        {cliente === "Edificios" && (
          <div className="global-item">
            <div className="icon-box">🔑</div>
