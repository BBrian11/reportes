        ...
        <div className="dashboard-content">
          ...
          {!filtros.cliente ? (
            <div className="grid-layout">
              ...
              <Charts eventos={eventosFiltrados} /> <div className="dashboard-content"><div className="table-section">
              <EventsTable eventos={eventosFiltrados} className="events-table-large" /> {/* ✅ Tabla más grande */}
            </div>    </div></div>
          ) : (
            <div className="grid-layout">
              <MiniCharts eventos={eventosFiltrados} />
              <LineAnalytics eventos={eventosFiltrados} cliente={filtros.cliente} fechaInicio={filtros.fechaInicio} fechaFin={filtros.fechaFin} />
              ...
              {filtros.cliente === "Otros" && <VtvStats eventos={eventosFiltrados} />}

              <div className="dashboard-content">
                <div className="grid-layout">
                  <EventsTable eventos={eventosFiltrados} className="events-table-large" />
                </div>
              </div>
            </div>
          )}
